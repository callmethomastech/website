  ...
  return (
    <div>
      <div className="flex flex-col w-5/6 pt-20 pb-10 items-center mx-auto md:flex-row">
        ...
        <div className="pl-5">
          <h1 className="text-4xl md:text-4xl mb-1 md:mb-3 font-bold">
            $Thomas Henderson<span className="animate-blinking">_</span>
          </h1>
          ...
          <div className="flex flex-row gap-4 pt-4">
            <a href="https://www.youtube.com/c/FADEDElement" target="_blank">
              <svg
            ...
            <a href="https://github.com/FADEDElement" target="_blank">
              <svg
                className="fill-alice-blue hover:fill-blue-green"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <a href="https://discord.com/invite/XdxwyrE" target="_blank">
              <svg
                className="fill-alice-blue hover:fill-blue-green"
                width="24"
                height="24"
      ...
      <div className="flex flex-row gap-4 w-5/6 mx-auto border-b-4 border-davys-grey">
        <a href="/" class="navbar--button navbtn--selected">
          Home
        </a>
