...
function Home() {
    return (
        <div>
            <div className="flex flex-col p-4 items-center bg-davys-grey w-full fixed md:flex-row">
            ...
            <div id="home" className="flex flex-col w-5/6 pt-28 md:pt-20 pb-10 items-center mx-auto md:flex-row border-b-4 border-davys-grey">
                ...
                <div className="pl-5">
                    ...
                    <p className="pb-4 md:pt-0 font-semibold">Software Engineer aka Professional Problem Solver</p>
